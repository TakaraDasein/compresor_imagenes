...
export default function ImageCompressorLocal({ onImagesCountChange }: ImageCompressorLocalProps) {
  ...
  const fileInputRef = useRef<HTMLInputElement>(null)  // Mantener para el botón "Añadir más imágenes"
  ...
  const DownloadButton: React.FC<DownloadButtonProps> = ({ imageUrl, fileName, outputFormat }) => {
